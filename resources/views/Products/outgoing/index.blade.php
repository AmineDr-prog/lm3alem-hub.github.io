...
<section class="tables">
    ...
    <h2>List of Outgoing Products</h2>
    ...
    @empty
        <tr>
            <td colspan="6">no outgoing products</td>
        </tr>
...
<div class="cont-edit">
    ...
    <div class="edit">
        <div class="card">
            ...
            <form action="{{route("productsOut.update","")}}" name="edi" method="Post">
                @method("put")
                @csrf
                    <select name="product">
                        <option selected="true" disabled="disabled">Choose Product</option>
